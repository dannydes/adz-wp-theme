		...
		<footer class="footer">
			...
			<div class="bottom">
				<div class="container row">
					...
					<?php if ( get_theme_mod_or_default( 'copyright_text_on' ) ): ?>
						...
						Some rights reserved. <span id="copyright-extra-text"><?php echo get_theme_mod_or_default( 'copyright_text_addition' ); ?></span>
					<?php endif; ?>
					</div>
				</div>
			</div>
